...
To further facilitate the reproduction of our work, due to file size limitations (≤25MB), we have provided the first 5,000 interactions of the deepseek V30 version for the Code-S dataset. After downloading this project, simply remove the "_5000" suffix from the file names to run the code properly!
